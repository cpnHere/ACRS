...
01/15/2018:
    To setup MSCART field file for RICO case
"""
import numpy as np
...
dy=LES_field('OP_dharma_008036_full_3_26.nc',dpath='/umbc/xfs1/zzbatmos/users/charaj1/taki/ACRS/LES_MSCART/')#DYCOM field file for MSCART
dy.readLES_field()

cloud=DHARMA_onmp('dharma_005044.cdf','/umbc/xfs1/zzbatmos/users/mild1/Research/LES/LES_Satellite_Simulator_DJM/LES_Simulations/Ackerman_RICO_NEW/');
cloud.readDHARMA()

extp3d,omgp3d,P11,P33,P12,P34,cloud_mie=cloud.setupMieOut('RICO_dharma_005044_mie_470_860_2p13',\
                            lesCname='RICO',mie_path='/umbc/xfs1/zzbatmos/users/charaj1/taki/ACRS/LES_simulations/')

bnd=2.13; fnfmt='%0.2f'%(bnd)
save_name='RICO_dharma_005044_b'+fnfmt
pkl_stamp='RICO_dharma_005044_b'+fnfmt
