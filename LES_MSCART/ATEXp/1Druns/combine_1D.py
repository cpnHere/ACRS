...
dsNew=MSlib.POLCARTdset('dsNew','/umbc/xfs1/zzbatmos/users/charaj1/LES_MSCART_v2/ATEXp/1Druns/LESb'+band+'_bins')
dsNew.readPOLCARThdf5(cname.split('NPH',1)[0]+'NPH1e6.hdf5','../results/b'+band+'/')

d3D=MSlib.LES_field('ATEXp_dharma_013067_b'+band+'.nc',dpath='../')
d3D.readLES_field()
