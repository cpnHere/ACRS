...
cloud=DHARMA_onmp('dharma_007877.cdf','/umbc/xfs1/zzbatmos/users/mild1/Research/LES/LES_Satellite_Simulator_DJM/LES_Simulations/Ackerman_ATEX_highres/CCN40/');
cloud.readDHARMA()
extp3d,omgp3d,P11,P33,P12,P34,cloud_mie=cloud.setupMieOut('DYCOM2_dharma_008036_mie_470_860_2p13',lesCname='ATEXc')

bnd=2.13
save_name='ATEXc_dharma_007877_b%0.2f'%(bnd)
pkl_stamp='ATEXc_dharma_007877_b%0.2f'%(bnd)
