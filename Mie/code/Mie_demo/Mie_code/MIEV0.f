...
c     .. Parameters ..
      ...
      PARAMETER ( MAXANG = 18001, MXANG2 = MAXANG / 2 + 1 )
      INTEGER   MAXTRM
      PARAMETER ( MAXTRM = 101000 )
      REAL      ONETHR
...
c     ..
      DATA      PASS1 / .FALSE. /
C*****  set PASS1 to be .FALSE. if run MIE code for real computation
c*****  if  PASS1 = .true. MIE code only does self test 
